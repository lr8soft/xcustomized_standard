...
GLuint xc_std::GLSL_reader::load_from_file(const char *path, GLenum type)
{
...
GLuint xc_std::GLSL_reader::load_from_info(const char *info,GLenum type)
{
...
GLuint xc_std::GLSL_reader::add_new_shader(GLuint shader, GLenum type)
{
